...
uniform 	vec2 _Angle;
uniform 	int _Obtuse;
uniform 	int _FrontShadow;
uniform 	int _BackShadow;
uniform 	int _InnerShadow;
uniform 	float _BackTransparency;
...
void main()
{
    ...
    u_xlatb9.xyz = equal(ivec4(_FrontShadow, _InnerShadow, _BackShadow, _BackShadow), ivec4(1, 1, 1, 1)).xyz;
    ...
    u_xlat1.x = u_xlatb9.x ? u_xlat1.x : float(0.0);
    u_xlat16_4.xyz = texture(_SecondTex, u_xlat7.xy).xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb7 = !!(0.0<u_xlat14.y);
#else
    u_xlatb7 = 0.0<u_xlat14.y;
#endif
    u_xlat13.x = (u_xlatb9.y) ? u_xlat14.y : 1.0;
    u_xlat3.xyz = u_xlat13.xxx * u_xlat16_4.xyz;
    u_xlat1.x = (-u_xlat1.x) + 1.0;
    u_xlat3.xyz = u_xlat1.xxx * u_xlat3.xyz;
    u_xlat1.x = (-_BackTransparency) + 1.0;
    u_xlat4.xyz = u_xlat16_4.xyz * vec3(vec3(_BackTransparency, _BackTransparency, _BackTransparency)) + u_xlat1.xxx;
    u_xlat1.x = (u_xlatb9.z) ? (-u_xlat14.y) : 1.0;
    u_xlat4.xyz = u_xlat1.xxx * u_xlat4.xyz;
    u_xlat1.xyz = (bool(u_xlatb7)) ? u_xlat3.xyz : u_xlat4.xyz;
    u_xlat2.x = u_xlat1.w * -2.0 + 3.0;
    u_xlat19 = u_xlat1.w * u_xlat1.w;
    u_xlat19 = u_xlat19 * u_xlat2.x;
    u_xlat19 = (u_xlatb9.z) ? u_xlat19 : 1.0;
...
void main()
{
    ...
    u_xlat1.x = u_xlat1.x * u_xlat8;
    u_xlat1.x = u_xlatb9.x ? u_xlat1.x : float(0.0);
    u_xlat16_4.xyz = texture(_MainTex, u_xlat7.xy).xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb7 = !!(0.0<u_xlat14.y);
#else
    u_xlatb7 = 0.0<u_xlat14.y;
