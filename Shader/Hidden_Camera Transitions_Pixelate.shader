...
{
    u_xlat0.x = (-_T) + 1.0;
    u_xlat0.x = min(u_xlat0.x, _T);
    u_xlat0.x = _PixelSize * u_xlat0.x + 1.0;
    u_xlat2.x = u_xlat0.x * 0.5;
    u_xlat2.xy = vs_TEXCOORD0.xy * _ScreenParams.xy + u_xlat2.xx;
    u_xlat2.xy = u_xlat2.xy / u_xlat0.xx;
    u_xlat2.xy = floor(u_xlat2.xy);
    u_xlat0.xy = u_xlat0.xx * u_xlat2.xy;
    u_xlat0.xy = u_xlat0.xy / _ScreenParams.xy;
    u_xlat16_1.xyz = texture(_SecondTex, u_xlat0.xy).xyz;
