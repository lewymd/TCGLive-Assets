...
//
///////////////////////////////////////////
Shader "TPCi/UI/UI_CollectAll_Beams" {
Properties {
_Texture_NonTiling ("Texture_NonTiling", 2D) = "white" { }
_tex4coord ("", 2D) = "white" { }
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
...
#define UNITY_BINDING(x) layout(std140)
#endif
UNITY_LOCATION(0) uniform mediump sampler2D _Texture_NonTiling;
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_Texture_NonTiling, u_xlat0.xy).xyz;
