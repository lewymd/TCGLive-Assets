...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_UI_ItemGranting_Shadow" {
Properties {
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x + (-_RadialGradientSmoothstepMin);
    u_xlat1 = (-_RadialGradientSmoothstepMin) + _RadialGradientSmoothstepMax;
...
#endif
    u_xlat0.xyz = vs_COLOR0.xyz * vec3(vec3(_Brightness, _Brightness, _Brightness));
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat0.x = sqrt(u_xlat0.x);
    u_xlat0.x = u_xlat0.x + (-_RadialGradientSmoothstepMin);
    u_xlat1.x = (-_RadialGradientSmoothstepMin) + _RadialGradientSmoothstepMax;
