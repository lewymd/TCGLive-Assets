...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_Simple_Trail_Additive" {
Properties {
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * vec2(_Tiling.x, _Tiling.y);
    u_xlat0.xy = _Time.yy * _PanSpeed.xy + u_xlat0.xy;
...
void main()
{
    ...
    u_xlat1.xy = vs_TEXCOORD0.xy * vec2(_Tiling.x, _Tiling.y);
    u_xlat1.xy = _Time.yy * _PanSpeed.xy + u_xlat1.xy;
