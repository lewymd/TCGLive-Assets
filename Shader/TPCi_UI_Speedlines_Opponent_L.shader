...
//
///////////////////////////////////////////
Shader "TPCi/UI/Speedlines_Opponent_L" {
Properties {
...
_ColorLight ("Color Light", Color) = (0.9716981,0.4301463,0.4170968,0)
_ColorDark ("Color Dark", Color) = (0.6792453,0.0828751,0.06728373,0)
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat2.xxx * vec3(0.100000001, 0.0774993747, 0.0734355971);
    u_xlat0.xyz = u_xlat0.xxx * vec3(0.234671474, 0.0554487742, 0.0469552018) + u_xlat2.xyz;
    ...
    u_xlat1.xyz = u_xlat1.xxx * vec3(0.837510586, 0.182891399, 0.0460701734);
    u_xlat1.xyz = vec3(u_xlat6) * vec3(0.419999987, 0.146883398, 0.0502061248) + u_xlat1.xyz;
    u_xlat0.xyz = u_xlat0.xyz + u_xlat1.xyz;
    u_xlat6 = vs_TEXCOORD0.y + 0.0599999987;
    u_xlat1.x = (-u_xlat6) + 1.0;
    u_xlat6 = u_xlat6 * u_xlat1.x;
    u_xlat6 = u_xlat6 * 5.65999985 + -0.469999999;
...
void main()
{
    ...
    u_xlat4.xyz = u_xlat4.xxx * vec3(0.100000001, 0.0774993747, 0.0734355971);
    u_xlat1.xyz = u_xlat1.xxx * vec3(0.234671474, 0.0554487742, 0.0469552018) + u_xlat4.xyz;
    ...
    u_xlat2.xyz = u_xlat2.xxx * vec3(0.837510586, 0.182891399, 0.0460701734);
    u_xlat2.xyz = vec3(u_xlat10) * vec3(0.419999987, 0.146883398, 0.0502061248) + u_xlat2.xyz;
    u_xlat1.xyz = u_xlat1.xyz + u_xlat2.xyz;
    u_xlat10 = vs_TEXCOORD0.y + 0.0599999987;
    u_xlat2.x = (-u_xlat10) + 1.0;
    u_xlat10 = u_xlat10 * u_xlat2.x;
    u_xlat10 = u_xlat10 * 5.65999985 + -0.469999999;
#ifdef UNITY_ADRENO_ES3
...
;
    ...
    u_xlat6.xyz = u_xlat6.xxx * vec3(0.100000001, 0.0774993747, 0.0734355971);
    u_xlat2.xyz = u_xlat2.xxx * vec3(0.234671474, 0.0554487742, 0.0469552018) + u_xlat6.xyz;
    u_xlat1 = _Time.yyyy * vec4(-0.300000012, -0.0299999993, -0.349999994, 0.0500000007);
    u_xlat1 = vs_TEXCOORD0.xyxy * vec4(0.100000001, 1.5, 0.0500000007, 1.29999995) + u_xlat1;
    ...
    u_xlat3.xyz = u_xlat3.xxx * vec3(0.837510586, 0.182891399, 0.0460701734);
    u_xlat3.xyz = vec3(u_xlat14) * vec3(0.419999987, 0.146883398, 0.0502061248) + u_xlat3.xyz;
    u_xlat2.xyz = u_xlat2.xyz + u_xlat3.xyz;
    u_xlat14 = vs_TEXCOORD0.y + 0.0599999987;
    u_xlat3.x = (-u_xlat14) + 1.0;
    u_xlat14 = u_xlat14 * u_xlat3.x;
    u_xlat14 = u_xlat14 * 5.65999985 + -0.469999999;
#ifdef UNITY_ADRENO_ES3
