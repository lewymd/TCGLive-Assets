...
void main()
{
    u_xlat0 = (-_GrayPhase) + 1.0;
    u_xlat3.x = (-u_xlat0) + _T;
    u_xlat6 = float(1.0) / (-u_xlat0);
    ...
    u_xlat3.xyz = u_xlat3.xxx * u_xlat1.xyz + vec3(u_xlat16_2);
    u_xlat1.x = _T + (-_GrayPhase);
    ...
    u_xlat16_2 = dot(u_xlat16_1.xyz, vec3(0.0396819152, 0.45802179, 0.00609653955));
    u_xlat1.xyz = u_xlat16_1.xyz + (-vec3(u_xlat16_2));
    u_xlat1.xyz = vec3(u_xlat0) * u_xlat1.xyz + vec3(u_xlat16_2);
    u_xlat1.xyz = (-u_xlat3.xyz) + u_xlat1.xyz;
    SV_Target0.xyz = vec3(_T) * u_xlat1.xyz + u_xlat3.xyz;
    SV_Target0.w = 1.0;
    return;
}
