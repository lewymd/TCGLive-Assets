...
void main()
{
...
#endif
    u_xlat8 = dot(u_xlat5.xyz, (-u_xlat2.xyz));
    ...
    u_xlat4.x = abs(u_xlat8) * u_xlat27 + u_xlat26;
    ...
    u_xlat16_14.x = u_xlat16_14.x * u_xlat16 + -0.5;
...
void main()
{
    ...
    u_xlat16_2 = texture(_CameraGBufferTexture1, u_xlat1.xy);
    u_xlat16_1.xyw = texture(_CameraGBufferTexture0, u_xlat1.xy).xyz;
    u_xlat23 = (-u_xlat16_2.w) + 1.0;
    u_xlat24 = u_xlat23 * u_xlat23;
    u_xlat24 = max(u_xlat24, 0.00200000009);
    u_xlat4 = u_xlat24 * u_xlat24;
    u_xlat11 = u_xlat21 * u_xlat4 + (-u_xlat21);
    ...
    u_xlat7 = dot(u_xlat3.xyz, (-_LightDir.xyz));
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat3.x = abs(u_xlat0.x) * u_xlat14 + u_xlat24;
    u_xlat14 = u_xlat7 * u_xlat14 + u_xlat24;
    u_xlat14 = u_xlat14 * abs(u_xlat0.x);
    u_xlat16_5.x = -abs(u_xlat0.x) + 1.0;
    u_xlat0.x = u_xlat7 * u_xlat3.x + u_xlat14;
...
void main()
{
    ...
    u_xlat16_14.xyz = u_xlat16_7.xyz * u_xlat16_14.xxx + u_xlat16_3.xyz;
    ...
    u_xlat16_14.x = u_xlat16_14.x * u_xlat16_22 + 1.0;
    u_xlat16_6.x = u_xlat16_6.x * u_xlat16_14.x;
    u_xlat24 = u_xlat26 * u_xlat16_6.x;
    u_xlat16_6.xyz = vec3(u_xlat24) * u_xlat0.xyz;
    u_xlat0.xyz = u_xlat16_4.xyz * u_xlat16_6.xyz + u_xlat2.xyz;
    u_xlat16_0.xyz = (-u_xlat0.xyz);
    u_xlat16_0.w = -1.0;
    SV_Target0 = exp2(u_xlat16_0);
    return;
...
void main()
{
    ...
    u_xlat4.x = abs(u_xlat2.x) * u_xlat18 + u_xlat27;
    u_xlat18 = u_xlat10 * u_xlat18 + u_xlat27;
    u_xlat18 = u_xlat18 * abs(u_xlat2.x);
    u_xlat16_6.x = -abs(u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat10 * u_xlat4.x + u_xlat18;
    ...
    u_xlat24 = u_xlat24 * u_xlat2.x;
    u_xlat2.xz = u_xlat0.yy * hlslcc_mtx4x4unity_WorldToLight[1].xy;
    u_xlat0.xy = hlslcc_mtx4x4unity_WorldToLight[0].xy * u_xlat0.xx + u_xlat2.xz;
    ...
    u_xlat16_14.x = u_xlat17 + u_xlat17;
    u_xlat16_14.x = u_xlat17 * u_xlat16_14.x;
    u_xlat16_14.x = u_xlat16_14.x * u_xlat26 + -0.5;
    u_xlat16_22 = u_xlat16_6.x * u_xlat16_6.x;
    u_xlat16_22 = u_xlat16_22 * u_xlat16_22;
    u_xlat16_6.x = u_xlat16_6.x * u_xlat16_22;
    u_xlat16_6.x = u_xlat16_14.x * u_xlat16_6.x + 1.0;
    u_xlat16_22 = (-u_xlat10) + 1.0;
    u_xlat16_30 = u_xlat16_22 * u_xlat16_22;
    u_xlat16_30 = u_xlat16_30 * u_xlat16_30;
    u_xlat16_22 = u_xlat16_22 * u_xlat16_30;
    u_xlat16_14.x = u_xlat16_14.x * u_xlat16_22 + 1.0;
    u_xlat16_6.x = u_xlat16_6.x * u_xlat16_14.x;
    u_xlat24 = u_xlat10 * u_xlat16_6.x;
    u_xlat16_6.xyz = vec3(u_xlat24) * u_xlat0.xyz;
    u_xlat0.xyz = u_xlat16_1.xyw * u_xlat16_6.xyz + u_xlat3.xyz;
    u_xlat16_0.xyz = (-u_xlat0.xyz);
    u_xlat16_0.w = -1.0;
    SV_Target0 = exp2(u_xlat16_0);
    return;
...
void main()
{
    ...
    u_xlat16_4.x = u_xlat0.x * u_xlat16_4.x + u_xlat8.x;
    ...
    u_xlat16_7.xyz = (-u_xlat16_2.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_12.xyz = u_xlat16_7.xyz * u_xlat16_12.xxx + u_xlat16_2.xyz;
    ...
    u_xlat0.xyz = u_xlat16_1.xyw * u_xlat16_4.xyz + u_xlat2.xyz;
    u_xlat16_0.xyz = (-u_xlat0.xyz);
    u_xlat16_0.w = -1.0;
    SV_Target0 = exp2(u_xlat16_0);
    return;
...
void main()
{
    ...
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat2.xyz = u_xlat0.xxx * u_xlat2.xyz;
    u_xlat4.xyz = u_xlat8.xyz * vec3(u_xlat17) + (-u_xlat2.xyz);
    u_xlat0.xyz = u_xlat8.xyz * vec3(u_xlat17);
    u_xlat24 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat24 = max(u_xlat24, 0.00100000005);
    u_xlat24 = inversesqrt(u_xlat24);
    ...
    u_xlat24 = u_xlat27 / u_xlat24;
    u_xlat27 = (-u_xlat26) + 1.0;
    u_xlat4.x = abs(u_xlat8.x) * u_xlat27 + u_xlat26;
    u_xlat26 = u_xlat0.x * u_xlat27 + u_xlat26;
    u_xlat26 = abs(u_xlat8.x) * u_xlat26;
    u_xlat16_6.x = -abs(u_xlat8.x) + 1.0;
    u_xlat8.x = u_xlat0.x * u_xlat4.x + u_xlat26;
    u_xlat8.x = u_xlat8.x + 9.99999975e-06;
    u_xlat8.x = 0.5 / u_xlat8.x;
    u_xlat8.x = u_xlat24 * u_xlat8.x;
    u_xlat8.x = u_xlat0.x * u_xlat8.x;
    ...
    u_xlat24 = u_xlatb24 ? 1.0 : float(0.0);
    u_xlat8.x = u_xlat24 * u_xlat8.x;
    u_xlat4.xyz = u_xlat3.xyz * u_xlat8.xxx;
    u_xlat16_14.x = (-u_xlat17) + 1.0;
    u_xlat16_22 = u_xlat16_14.x * u_xlat16_14.x;
    u_xlat16_22 = u_xlat16_22 * u_xlat16_22;
    u_xlat16_14.x = u_xlat16_14.x * u_xlat16_22;
...
void main()
{
    ...
    u_xlat16_12.x = (-u_xlat16_21) + 1.0;
    u_xlat16_12.x = u_xlat0.x * u_xlat16_12.x + u_xlat16_21;
    ...
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_5.xyz + u_xlat0.xyw;
    u_xlat16_0.xyz = (-u_xlat0.xyz);
    u_xlat16_0.w = -1.0;
    SV_Target0 = exp2(u_xlat16_0);
    return;
...
void main()
{
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
#endif
    u_xlat16_8 = texture(_ShadowMapTexture, u_xlat1.xy).x;
    ...
    u_xlat6 = u_xlat24 * u_xlat29 + (-u_xlat24);
    u_xlat24 = u_xlat6 * u_xlat24 + 1.0;
    u_xlat24 = u_xlat24 * u_xlat24 + 1.00000001e-07;
    u_xlat29 = u_xlat29 * 0.318309873;
    u_xlat24 = u_xlat29 / u_xlat24;
    u_xlat2.x = dot(u_xlat5.xyz, (-u_xlat2.xyz));
    u_xlat10 = dot(u_xlat5.xyz, (-_LightDir.xyz));
#ifdef UNITY_ADRENO_ES3
    u_xlat10 = min(max(u_xlat10, 0.0), 1.0);
#else
    u_xlat10 = clamp(u_xlat10, 0.0, 1.0);
#endif
    u_xlat18 = (-u_xlat27) + 1.0;
    u_xlat5.x = abs(u_xlat2.x) * u_xlat18 + u_xlat27;
    u_xlat18 = u_xlat10 * u_xlat18 + u_xlat27;
    u_xlat18 = u_xlat18 * abs(u_xlat2.x);
    u_xlat16_4.x = -abs(u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat10 * u_xlat5.x + u_xlat18;
    u_xlat2.x = u_xlat2.x + 9.99999975e-06;
    u_xlat2.x = 0.5 / u_xlat2.x;
    u_xlat24 = u_xlat24 * u_xlat2.x;
    u_xlat24 = u_xlat10 * u_xlat24;
    ...
    u_xlat16_12.x = u_xlat16_12.x * u_xlat16_20;
    u_xlat16_7.xyz = (-u_xlat16_3.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_12.xyz = u_xlat16_7.xyz * u_xlat16_12.xxx + u_xlat16_3.xyz;
    u_xlat3.xyz = u_xlat16_12.xyz * u_xlat5.xyz;
    u_xlat16_12.x = u_xlat17 + u_xlat17;
    u_xlat16_12.x = u_xlat17 * u_xlat16_12.x;
    u_xlat16_12.x = u_xlat16_12.x * u_xlat26 + -0.5;
    u_xlat16_20 = u_xlat16_4.x * u_xlat16_4.x;
    u_xlat16_20 = u_xlat16_20 * u_xlat16_20;
    u_xlat16_4.x = u_xlat16_4.x * u_xlat16_20;
    u_xlat16_4.x = u_xlat16_12.x * u_xlat16_4.x + 1.0;
    u_xlat16_20 = (-u_xlat10) + 1.0;
    u_xlat16_28 = u_xlat16_20 * u_xlat16_20;
    u_xlat16_28 = u_xlat16_28 * u_xlat16_28;
    u_xlat16_20 = u_xlat16_20 * u_xlat16_28;
    u_xlat16_12.x = u_xlat16_12.x * u_xlat16_20 + 1.0;
    u_xlat16_4.x = u_xlat16_4.x * u_xlat16_12.x;
    u_xlat24 = u_xlat10 * u_xlat16_4.x;
    u_xlat16_4.xyz = vec3(u_xlat24) * u_xlat0.xyz;
    u_xlat0.xyz = u_xlat16_1.xyw * u_xlat16_4.xyz + u_xlat3.xyz;
    u_xlat16_0.xyz = (-u_xlat0.xyz);
    u_xlat16_0.w = -1.0;
    SV_Target0 = exp2(u_xlat16_0);
    return;
...
void main()
{
    ...
    u_xlat16_4.x = u_xlat17 * u_xlat16_4.x + _LightShadowData.x;
...
void main()
{
    ...
    u_xlat26 = u_xlat0.x * u_xlat27 + u_xlat26;
    u_xlat26 = abs(u_xlat8.x) * u_xlat26;
    u_xlat16_5.x = -abs(u_xlat8.x) + 1.0;
    u_xlat8.x = u_xlat0.x * u_xlat4.x + u_xlat26;
    u_xlat8.x = u_xlat8.x + 9.99999975e-06;
    u_xlat8.x = 0.5 / u_xlat8.x;
    u_xlat8.x = u_xlat24 * u_xlat8.x;
    ...
    u_xlat8.x = u_xlat24 * u_xlat8.x;
    u_xlat4.xyz = u_xlat3.xyz * u_xlat8.xxx;
    u_xlat16_13.x = (-u_xlat17) + 1.0;
    u_xlat16_21 = u_xlat16_13.x * u_xlat16_13.x;
    u_xlat16_21 = u_xlat16_21 * u_xlat16_21;
    u_xlat16_13.x = u_xlat16_13.x * u_xlat16_21;
    u_xlat16_7.xyz = (-u_xlat16_2.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_13.xyz = u_xlat16_7.xyz * u_xlat16_13.xxx + u_xlat16_2.xyz;
    u_xlat2.xyz = u_xlat4.xyz * u_xlat16_13.xyz;
    u_xlat16_13.x = u_xlat16_5.x * u_xlat16_5.x;
    u_xlat16_13.x = u_xlat16_13.x * u_xlat16_13.x;
    u_xlat16_5.x = u_xlat16_5.x * u_xlat16_13.x;
    u_xlat16_13.x = u_xlat17 + u_xlat17;
    u_xlat16_13.x = u_xlat17 * u_xlat16_13.x;
    u_xlat16_13.x = u_xlat16_13.x * u_xlat16 + -0.5;
    u_xlat16_5.x = u_xlat16_13.x * u_xlat16_5.x + 1.0;
    u_xlat16_21 = (-u_xlat0.x) + 1.0;
    u_xlat16_29 = u_xlat16_21 * u_xlat16_21;
    u_xlat16_29 = u_xlat16_29 * u_xlat16_29;
    u_xlat16_21 = u_xlat16_21 * u_xlat16_29;
    u_xlat16_13.x = u_xlat16_13.x * u_xlat16_21 + 1.0;
    u_xlat16_5.x = u_xlat16_5.x * u_xlat16_13.x;
    u_xlat0.x = u_xlat0.x * u_xlat16_5.x;
    u_xlat16_5.xyz = u_xlat0.xxx * u_xlat3.xyz;
    u_xlat0.xyz = u_xlat16_1.xyw * u_xlat16_5.xyz + u_xlat2.xyz;
    u_xlat16_0.xyz = (-u_xlat0.xyz);
    u_xlat16_0.w = -1.0;
    SV_Target0 = exp2(u_xlat16_0);
    return;
