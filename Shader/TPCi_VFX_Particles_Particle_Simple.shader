...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_Simple" {
Properties {
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat16_0.xyz + vec3(vec3(_AddWhite, _AddWhite, _AddWhite));
    ...
    u_xlat0.xyz = u_xlat2.xyz * vs_COLOR0.xyz;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_2.xyz + vec3(vec3(_AddWhite, _AddWhite, _AddWhite));
#ifdef UNITY_ADRENO_ES3
