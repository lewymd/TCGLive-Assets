...
//
///////////////////////////////////////////
Shader "UnityLowMemoryBlur" {
Properties {
_Offset1 ("Offset", Float) = 0.001
_Offset2 ("Offset", Float) = 0.001
__dirty ("", Float) = 1
}
SubShader {
...
void main()
{
    ...
    u_xlat49 = vs_TEXCOORD2.w + 9.99999996e-12;
    u_xlat2.xy = vs_TEXCOORD2.xy / vec2(u_xlat49);
    u_xlat3.y = _Offset1;
    u_xlat3.x = float(0.0);
    u_xlat35.x = float(0.0);
    u_xlat4 = u_xlat2.xyxy + u_xlat3.yxxy;
    u_xlat16_5.xyz = texture(_GrabTexture, u_xlat4.xy).xyz;
    u_xlat6 = u_xlat2.xyxy + vec4(_Offset1, _Offset1, _Offset2, _Offset2);
    u_xlat16_7.xyz = texture(_GrabTexture, u_xlat6.xy).xyz;
    u_xlat16_4.xyz = texture(_GrabTexture, u_xlat4.zw).xyz;
    u_xlat35.y = (-_Offset1);
    u_xlat3 = u_xlat2.xyxy + u_xlat35.yxxy;
    u_xlat16_8.xyz = texture(_GrabTexture, u_xlat3.xy).xyz;
    u_xlat9 = u_xlat2.xyxy + (-vec4(_Offset1, _Offset1, _Offset2, _Offset2));
    u_xlat16_10.xyz = texture(_GrabTexture, u_xlat9.xy).xyz;
    u_xlat16_3.xyz = texture(_GrabTexture, u_xlat3.zw).xyz;
    u_xlat11.y = _Offset2;
    u_xlat11.x = float(0.0);
    u_xlat43.x = float(0.0);
    u_xlat12 = u_xlat2.xyxy + u_xlat11.yxxy;
    u_xlat16_13.xyz = texture(_GrabTexture, u_xlat12.xy).xyz;
    u_xlat16_6.xyz = texture(_GrabTexture, u_xlat6.zw).xyz;
    u_xlat16_12.xyz = texture(_GrabTexture, u_xlat12.zw).xyz;
    u_xlat43.y = (-_Offset2);
    u_xlat2 = u_xlat2.xyxy + u_xlat43.yxxy;
    u_xlat16_11.xyz = texture(_GrabTexture, u_xlat2.xy).xyz;
    u_xlat16_9.xyz = texture(_GrabTexture, u_xlat9.zw).xyz;
    u_xlat16_2.xyz = texture(_GrabTexture, u_xlat2.zw).xyz;
    u_xlat5.xyz = u_xlat16_5.xyz + u_xlat16_7.xyz;
    ...
    u_xlat4.xyz = u_xlat16_6.xyz + u_xlat16_13.xyz;
    ...
    u_xlat2.xyz = u_xlat3.xyz * vec3(0.166666672, 0.166666672, 0.166666672) + u_xlat2.xyz;
    ...
    if(u_xlatb49){
        ...
        u_xlat3.xyz = vec3(u_xlat49) * u_xlat16_14.xyz;
        ...
        u_xlat49 = min(u_xlat4.y, u_xlat4.x);
        u_xlat49 = min(u_xlat4.z, u_xlat49);
        u_xlat4.xyz = vs_TEXCOORD1.xyz + (-unity_SpecCube0_ProbePosition.xyz);
        u_xlat3.xyz = u_xlat3.xyz * vec3(u_xlat49) + u_xlat4.xyz;
    } else {
    ...
    u_xlat16_15.xyz = u_xlat16_3.xyz * vec3(u_xlat16_62);
#ifdef UNITY_ADRENO_ES3
    ...
    if(u_xlatb49){
        ...
        if(u_xlatb49){
            u_xlat49 = dot(u_xlat16_14.xyz, u_xlat16_14.xyz);
            u_xlat49 = inversesqrt(u_xlat49);
            u_xlat4.xyz = vec3(u_xlat49) * u_xlat16_14.xyz;
            ...
            u_xlat49 = min(u_xlat5.y, u_xlat5.x);
            u_xlat49 = min(u_xlat5.z, u_xlat49);
        ...
        u_xlat3.xyz = vec3(u_xlat16_62) * u_xlat16_3.xyz + (-u_xlat16_14.xyz);
        u_xlat15.xyz = unity_SpecCube0_BoxMin.www * u_xlat3.xyz + u_xlat16_14.xyz;
        u_xlat16_15.xyz = u_xlat15.xyz;
    }
    u_xlat49 = dot(vs_TEXCOORD0.xyz, vs_TEXCOORD0.xyz);
    u_xlat49 = inversesqrt(u_xlat49);
    u_xlat3.xyz = vec3(u_xlat49) * vs_TEXCOORD0.xyz;
...
#endif
    u_xlat16 = abs(u_xlat48) + u_xlat1.x;
    ...
    u_xlat16_14.x = u_xlat16_14.x * 0.959999979 + 0.0399999991;
    u_xlat16_30.xyz = u_xlat16_15.xyz * vec3(0.5, 0.5, 0.5);
    u_xlat16_15.x = -abs(u_xlat48) + 1.0;
    u_xlat16_31 = u_xlat16_15.x * u_xlat16_15.x;
    u_xlat16_31 = u_xlat16_31 * u_xlat16_31;
    u_xlat16_15.x = u_xlat16_15.x * u_xlat16_31;
    u_xlat16_15.x = u_xlat16_15.x * 2.23517418e-08 + 0.0399999991;
    u_xlat16_30.xyz = u_xlat16_30.xyz * u_xlat16_15.xxx;
    u_xlat0.xyz = u_xlat1.xyz * u_xlat16_14.xxx + u_xlat16_30.xyz;
...
void main()
{
    ...
    u_xlat52 = vs_TEXCOORD2.w + 9.99999996e-12;
    u_xlat2.xy = vs_TEXCOORD2.xy / vec2(u_xlat52);
    u_xlat3.y = _Offset1;
    u_xlat3.x = float(0.0);
    ...
    u_xlat16_4.xyz = texture(_GrabTexture, u_xlat4.zw).xyz;
    u_xlat37.y = (-_Offset1);
    u_xlat3 = u_xlat2.xyxy + u_xlat37.yxxy;
    u_xlat16_8.xyz = texture(_GrabTexture, u_xlat3.xy).xyz;
    u_xlat9 = u_xlat2.xyxy + (-vec4(_Offset1, _Offset1, _Offset2, _Offset2));
    u_xlat16_10.xyz = texture(_GrabTexture, u_xlat9.xy).xyz;
    u_xlat16_3.xyz = texture(_GrabTexture, u_xlat3.zw).xyz;
    ...
    u_xlat16_12.xyz = texture(_GrabTexture, u_xlat12.zw).xyz;
    u_xlat45.y = (-_Offset2);
    u_xlat2 = u_xlat2.xyxy + u_xlat45.yxxy;
    u_xlat16_11.xyz = texture(_GrabTexture, u_xlat2.xy).xyz;
    u_xlat16_9.xyz = texture(_GrabTexture, u_xlat9.zw).xyz;
    u_xlat16_2.xyz = texture(_GrabTexture, u_xlat2.zw).xyz;
    u_xlat5.xyz = u_xlat16_5.xyz + u_xlat16_7.xyz;
    ...
    u_xlat53 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec0, 0.0);
    u_xlat16_14 = (-_LightShadowData.x) + 1.0;
    u_xlat16_14 = u_xlat53 * u_xlat16_14 + _LightShadowData.x;
    u_xlat16_31.x = (-u_xlat16_14) + 1.0;
    u_xlat16_14 = u_xlat52 * u_xlat16_31.x + u_xlat16_14;
    u_xlat16_31.x = dot((-u_xlat1.xyz), vs_TEXCOORD0.xyz);
    u_xlat16_31.x = u_xlat16_31.x + u_xlat16_31.x;
    u_xlat16_31.xyz = vs_TEXCOORD0.xyz * (-u_xlat16_31.xxx) + (-u_xlat1.xyz);
    u_xlat16_15.xyz = vec3(u_xlat16_14) * _LightColor0.xyz;
#ifdef UNITY_ADRENO_ES3
...
#endif
    if(u_xlatb52){
        u_xlat52 = dot(u_xlat16_31.xyz, u_xlat16_31.xyz);
        u_xlat52 = inversesqrt(u_xlat52);
        u_xlat3.xyz = vec3(u_xlat52) * u_xlat16_31.xyz;
        u_xlat4.xyz = (-vs_TEXCOORD1.xyz) + unity_SpecCube0_BoxMax.xyz;
        u_xlat4.xyz = u_xlat4.xyz / u_xlat3.xyz;
        u_xlat5.xyz = (-vs_TEXCOORD1.xyz) + unity_SpecCube0_BoxMin.xyz;
        u_xlat5.xyz = u_xlat5.xyz / u_xlat3.xyz;
        ...
        u_xlat52 = min(u_xlat4.y, u_xlat4.x);
        u_xlat52 = min(u_xlat4.z, u_xlat52);
        u_xlat4.xyz = vs_TEXCOORD1.xyz + (-unity_SpecCube0_ProbePosition.xyz);
        u_xlat3.xyz = u_xlat3.xyz * vec3(u_xlat52) + u_xlat4.xyz;
    } else {
        u_xlat3.xyz = u_xlat16_31.xyz;
    }
    u_xlat16_3 = textureLod(unity_SpecCube0, u_xlat3.xyz, 6.0);
    ...
    u_xlat16_16.xyz = u_xlat16_3.xyz * vec3(u_xlat16_14);
#ifdef UNITY_ADRENO_ES3
    ...
    if(u_xlatb52){
        ...
        if(u_xlatb52){
            u_xlat52 = dot(u_xlat16_31.xyz, u_xlat16_31.xyz);
            u_xlat52 = inversesqrt(u_xlat52);
            u_xlat4.xyz = vec3(u_xlat52) * u_xlat16_31.xyz;
            u_xlat5.xyz = (-vs_TEXCOORD1.xyz) + unity_SpecCube1_BoxMax.xyz;
            u_xlat5.xyz = u_xlat5.xyz / u_xlat4.xyz;
            u_xlat6.xyz = (-vs_TEXCOORD1.xyz) + unity_SpecCube1_BoxMin.xyz;
            u_xlat6.xyz = u_xlat6.xyz / u_xlat4.xyz;
            ...
            u_xlat52 = min(u_xlat5.y, u_xlat5.x);
            u_xlat52 = min(u_xlat5.z, u_xlat52);
            u_xlat5.xyz = vs_TEXCOORD1.xyz + (-unity_SpecCube1_ProbePosition.xyz);
            u_xlat4.xyz = u_xlat4.xyz * vec3(u_xlat52) + u_xlat5.xyz;
        } else {
            u_xlat4.xyz = u_xlat16_31.xyz;
        }
        u_xlat16_4 = textureLod(unity_SpecCube1, u_xlat4.xyz, 6.0);
        ...
        u_xlat16_31.xyz = u_xlat16_4.xyz * u_xlat16_31.xxx;
        u_xlat3.xyz = vec3(u_xlat16_14) * u_xlat16_3.xyz + (-u_xlat16_31.xyz);
        u_xlat16.xyz = unity_SpecCube0_BoxMin.www * u_xlat3.xyz + u_xlat16_31.xyz;
        u_xlat16_16.xyz = u_xlat16.xyz;
    }
    u_xlat52 = dot(vs_TEXCOORD0.xyz, vs_TEXCOORD0.xyz);
    u_xlat52 = inversesqrt(u_xlat52);
    u_xlat3.xyz = vec3(u_xlat52) * vs_TEXCOORD0.xyz;
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
#endif
    u_xlat17 = abs(u_xlat51) + u_xlat1.x;
    u_xlat17 = u_xlat17 + 9.99999975e-06;
    u_xlat17 = 0.5 / u_xlat17;
    u_xlat17 = u_xlat1.x * u_xlat17;
    u_xlat17 = u_xlat17 * 0.999999881;
    u_xlat1.xyz = u_xlat16_15.xyz * vec3(u_xlat17);
    u_xlat16_14 = (-u_xlat0.x) + 1.0;
    u_xlat16_31.x = u_xlat16_14 * u_xlat16_14;
    u_xlat16_31.x = u_xlat16_31.x * u_xlat16_31.x;
    u_xlat16_14 = u_xlat16_14 * u_xlat16_31.x;
    u_xlat16_14 = u_xlat16_14 * 0.959999979 + 0.0399999991;
    u_xlat16_31.xyz = u_xlat16_16.xyz * vec3(0.5, 0.5, 0.5);
    ...
    u_xlat0.xyz = u_xlat1.xyz * vec3(u_xlat16_14) + u_xlat16_31.xyz;
    SV_Target0.xyz = u_xlat2.xyz * vec3(0.5, 0.5, 0.5) + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
...
#endif
    u_xlat16_3 = (-u_xlat12) + 1.0;
    u_xlat16_7.x = u_xlat16_3 * u_xlat16_3;
    u_xlat16_7.x = u_xlat16_7.x * u_xlat16_7.x;
    u_xlat16_3 = u_xlat16_3 * u_xlat16_7.x;
    u_xlat16_3 = u_xlat16_3 * 0.959999979 + 0.0399999991;
    ...
    u_xlat0.xyz = vec3(u_xlat16_3) * u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat15 = u_xlat15 * 0.999999881;
    u_xlat1.xyz = u_xlat16_2.xyz * vec3(u_xlat15);
    u_xlat15 = dot(u_xlat0.xyz, u_xlat0.xyz);
    ...
    u_xlat0.xyz = u_xlat1.xyz * u_xlat16_2.xxx;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_1.x * 0.959999979 + 0.0399999991;
...
void main()
{
    ...
    u_xlat16_1.x = (-_LightShadowData.x) + 1.0;
    u_xlat16_1.x = u_xlat4.x * u_xlat16_1.x + _LightShadowData.x;
    u_xlat16_5 = (-u_xlat16_1.x) + 1.0;
    ...
    u_xlat4.x = unity_ShadowFadeCenterAndType.w * u_xlat4.x + u_xlat8;
    ...
    u_xlat4.x = clamp(u_xlat4.x, 0.0, 1.0);
#endif
    u_xlat16_1.x = u_xlat4.x * u_xlat16_5 + u_xlat16_1.x;
    u_xlat0.x = u_xlat0.x * u_xlat16_1.x;
    u_xlat16_1.xyz = u_xlat0.xxx * _LightColor0.xyz;
    u_xlat0.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat4.xyz = u_xlat0.xxx * u_xlat3.xyz;
    u_xlat2.xyz = u_xlat3.xyz * u_xlat0.xxx + _WorldSpaceLightPos0.xyz;
    u_xlat0.x = dot(vs_TEXCOORD0.xyz, vs_TEXCOORD0.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
...
void main()
{
    ...
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
#endif
    u_xlat15 = abs(u_xlat15) + u_xlat2.x;
    u_xlat15 = u_xlat15 + 9.99999975e-06;
    u_xlat15 = 0.5 / u_xlat15;
...
#endif
    u_xlat16_1.x = (-u_xlat0.x) + 1.0;
    u_xlat16_6 = u_xlat16_1.x * u_xlat16_1.x;
...
void main()
{
    ...
    u_xlat16 = inversesqrt(u_xlat16);
    u_xlat4.xyz = vec3(u_xlat16) * u_xlat2.xyz;
    ...
    u_xlat15 = u_xlat1.x * u_xlat15;
    u_xlat15 = u_xlat15 * 0.999999881;
    u_xlat1.xyz = u_xlat16_3.xyz * vec3(u_xlat15);
    u_xlat15 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat15 = max(u_xlat15, 0.00100000005);
    u_xlat15 = inversesqrt(u_xlat15);
    u_xlat0.xyz = vec3(u_xlat15) * u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat1.xy = vs_TEXCOORD2.xy / u_xlat1.xx;
    u_xlat2 = u_xlat0.yxxy + u_xlat1.xyxy;
    u_xlat16_3.xyz = texture(_GrabTexture, u_xlat2.xy).xyz;
    u_xlat16_2.xyz = texture(_GrabTexture, u_xlat2.zw).xyz;
    u_xlat4 = u_xlat1.xyxy + vec4(_Offset1, _Offset1, _Offset2, _Offset2);
    u_xlat16_5.xyz = texture(_GrabTexture, u_xlat4.zw).xyz;
    ...
    u_xlat14.y = (-_Offset2);
    u_xlat0 = u_xlat14.yxxy + u_xlat1.xyxy;
    u_xlat16_3.xyz = texture(_GrabTexture, u_xlat0.xy).xyz;
    u_xlat16_0.xyz = texture(_GrabTexture, u_xlat0.zw).xyz;
    u_xlat2.xyz = u_xlat2.xyz + u_xlat16_3.xyz;
    u_xlat3 = u_xlat1.xyxy + (-vec4(_Offset1, _Offset1, _Offset2, _Offset2));
    u_xlat16_5.xyz = texture(_GrabTexture, u_xlat3.zw).xyz;
    ...
    u_xlat5 = u_xlat1.xyxy + u_xlat2.yxxy;
    u_xlat16_6.xyz = texture(_GrabTexture, u_xlat5.xy).xyz;
    u_xlat16_5.xyz = texture(_GrabTexture, u_xlat5.zw).xyz;
    u_xlat4.xyz = u_xlat16_4.xyz + u_xlat16_6.xyz;
    u_xlat4.xyz = u_xlat16_5.xyz + u_xlat4.xyz;
    u_xlat16.y = (-_Offset1);
    u_xlat1 = u_xlat1.xyxy + u_xlat16.yxxy;
    u_xlat16_2.xyz = texture(_GrabTexture, u_xlat1.xy).xyz;
    u_xlat16_1.xyz = texture(_GrabTexture, u_xlat1.zw).xyz;
    u_xlat2.xyz = u_xlat16_2.xyz + u_xlat4.xyz;
