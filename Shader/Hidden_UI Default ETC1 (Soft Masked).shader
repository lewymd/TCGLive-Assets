...
UNITY_LOCATION(0) uniform mediump sampler2D _MainTex;
UNITY_LOCATION(1) uniform mediump sampler2D _AlphaTex;
UNITY_LOCATION(2) uniform mediump sampler2D _SoftMask;
in mediump vec4 vs_COLOR0;
in highp vec2 vs_TEXCOORD0;
...
;
    ...
    u_xlat1.xyz = u_xlat16_2.xyz + _TextureSampleAdd.xyz;
    u_xlat16_2.x = texture(_AlphaTex, vs_TEXCOORD0.xy).x;
    u_xlat1.w = u_xlat16_2.x + _TextureSampleAdd.w;
...
;
    ...
    u_xlat1.xyz = u_xlat16_4.xyz + _TextureSampleAdd.xyz;
    u_xlat16_4.x = texture(_AlphaTex, vs_TEXCOORD0.xy).x;
    u_xlat1.w = u_xlat16_4.x + _TextureSampleAdd.w;
    u_xlat16_1 = u_xlat1 * vs_COLOR0;
    u_xlat0.x = u_xlat0.x * u_xlat16_1.w;
    SV_Target0.xyz = u_xlat16_1.xyz;
    SV_Target0.w = u_xlat0.x;
...
;
    ...
    u_xlat16_3.x = texture(_AlphaTex, vs_TEXCOORD0.xy).x;
    u_xlat1.w = u_xlat16_3.x + _TextureSampleAdd.w;
    u_xlat16_1 = u_xlat1 * vs_COLOR0;
...
;
    ...
    u_xlat1.xyz = u_xlat16_5.xyz + _TextureSampleAdd.xyz;
    u_xlat16_5.x = texture(_AlphaTex, vs_TEXCOORD0.xy).x;
    u_xlat1.w = u_xlat16_5.x + _TextureSampleAdd.w;
    u_xlat16_1 = u_xlat1 * vs_COLOR0;
