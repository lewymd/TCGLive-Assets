...
void main()
{
    ...
    u_xlat16_3 = texture(_OutlineTex, u_xlat11.xy);
    u_xlat11.xyz = u_xlat16_3.xyz * _OutlineColor.xyz;
    u_xlat3.x = vs_COLOR0.w * _OutlineColor.w;
    u_xlat12 = u_xlat16_3.w * u_xlat3.x;
    ...
    u_xlat16_7.xyz = u_xlat11.xyz * vec3(u_xlat12) + (-u_xlat16_7.xyz);
    u_xlat16_7.w = u_xlat3.x * u_xlat16_3.w + (-u_xlat6.w);
    u_xlat16_3 = vec4(u_xlat16_28) * u_xlat16_7;
    ...
    u_xlat11.x = u_xlat2.x * vs_TEXCOORD5.y;
    u_xlat16_7.x = u_xlat2.x * vs_TEXCOORD5.y + 1.0;
    u_xlat16_28 = u_xlat11.x * 0.5 + u_xlat16_28;
    ...
    u_xlat16_2 = vec4(u_xlat16_28) * u_xlat16_4;
    u_xlat6.x = (-_BumpFace) + _BumpOutline;
    u_xlat6.x = u_xlat27 * u_xlat6.x + _BumpFace;
    ...
    u_xlat15 = (-_FaceShininess) + _OutlineShininess;
    u_xlat15 = u_xlat27 * u_xlat15 + _FaceShininess;
    u_xlat16_1.x = u_xlat15 * 128.0;
    ...
    u_xlat8.xyz = u_xlat16_2.xyz / vec3(u_xlat33);
    u_xlat16_10.xyz = u_xlat8.xyz * _LightColor0.xyz;
    u_xlat6.xyz = u_xlat16_10.xyz * u_xlat16_1.xxx + u_xlat6.xyz;
    u_xlat3.w = 1.0;
    ...
    u_xlat16_1.xyz = u_xlat8.xyz * u_xlat16_1.xyz + u_xlat6.xyz;
    u_xlat6.xyz = (-_ReflectFaceColor.xyz) + _ReflectOutlineColor.xyz;
    u_xlat6.xyz = vec3(u_xlat27) * u_xlat6.xyz + _ReflectFaceColor.xyz;
    ...
    u_xlat27 = dot(vs_TEXCOORD6.xyz, u_xlat0.xyz);
    u_xlat27 = u_xlat27 + u_xlat27;
    u_xlat0.xyz = u_xlat0.xyz * (-vec3(u_xlat27)) + vs_TEXCOORD6.xyz;
