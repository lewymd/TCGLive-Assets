...
//
///////////////////////////////////////////
Shader "TPCi/UI/Speedlines_Player" {
Properties {
...
void main()
{
    ...
    u_xlat1.xyz = u_xlat1.xxx * vec3(0.0466265529, 0.293752044, 0.840029001);
    u_xlat1.xyz = vec3(u_xlat6) * vec3(0.0506732501, 0.179277509, 0.419999987) + u_xlat1.xyz;
    u_xlat0.xyz = u_xlat0.xyz + u_xlat1.xyz;
    u_xlat6 = vs_TEXCOORD0.y + -0.119999997;
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat2.xxx * vec3(0.0466265529, 0.293752044, 0.840029001);
    u_xlat2.xyz = vec3(u_xlat10) * vec3(0.0506732501, 0.179277509, 0.419999987) + u_xlat2.xyz;
    u_xlat1.xyz = u_xlat1.xyz + u_xlat2.xyz;
    u_xlat10 = vs_TEXCOORD0.y + -0.119999997;
...
;
    ...
    u_xlat3.xyz = u_xlat3.xxx * vec3(0.0466265529, 0.293752044, 0.840029001);
    u_xlat3.xyz = vec3(u_xlat14) * vec3(0.0506732501, 0.179277509, 0.419999987) + u_xlat3.xyz;
    u_xlat2.xyz = u_xlat2.xyz + u_xlat3.xyz;
    u_xlat14 = vs_TEXCOORD0.y + -0.119999997;
