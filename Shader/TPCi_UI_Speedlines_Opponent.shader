...
//
///////////////////////////////////////////
Shader "TPCi/UI/Speedlines_Opponent" {
Properties {
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat2.xxx * vec3(0.100000001, 0.0774993822, 0.0734355971);
    ...
    u_xlat1.xyz = u_xlat1.xxx * vec3(0.837510705, 0.182891399, 0.0460701622);
...
void main()
{
    ...
    u_xlat4.xyz = u_xlat4.xxx * vec3(0.100000001, 0.0774993822, 0.0734355971);
    ...
    u_xlat2.xyz = u_xlat2.xxx * vec3(0.837510705, 0.182891399, 0.0460701622);
...
;
    ...
    u_xlat6.xyz = u_xlat6.xxx * vec3(0.100000001, 0.0774993822, 0.0734355971);
    ...
    u_xlat3.xyz = u_xlat3.xxx * vec3(0.837510705, 0.182891399, 0.0460701622);
