...
//
///////////////////////////////////////////
Shader "TPCi/UI/VSScreen_HexWipe_L" {
Properties {
...
void main()
{
    ...
    u_xlat2.xy = u_xlat2.xy + vec2(-0.800000012, -0.0);
    u_xlat31 = dot(u_xlat2.xy, vec2(-0.967709184, 0.252069354));
...
void main()
{
    ...
    u_xlat0.xy = u_xlat0.xy + vec2(-0.800000012, -0.0);
    u_xlat0.x = dot(u_xlat0.xy, vec2(-0.967709184, 0.252069354));
