...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_Simple_Alpha" {
Properties {
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _ParticleAlpha_ST.xy + _ParticleAlpha_ST.zw;
    u_xlat16_0.xy = texture(_ParticleAlpha, u_xlat0.xy).xw;
    u_xlat2 = (-u_xlat16_0.x) + u_xlat16_0.y;
    u_xlat0.x = _AlphaChannel * u_xlat2 + u_xlat16_0.x;
    u_xlat0.x = u_xlat0.x * _Alpha_Intensity;
    ...
    u_xlat0.xyz = u_xlat1.xyz * vec3(vec3(_Brightness, _Brightness, _Brightness));
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat2.xy = vs_TEXCOORD0.xy * _ParticleAlpha_ST.xy + _ParticleAlpha_ST.zw;
    u_xlat16_2.xy = texture(_ParticleAlpha, u_xlat2.xy).xw;
    u_xlat4 = (-u_xlat16_2.x) + u_xlat16_2.y;
    u_xlat2.x = _AlphaChannel * u_xlat4 + u_xlat16_2.x;
    u_xlat2.x = u_xlat2.x * _Alpha_Intensity;
#ifdef UNITY_ADRENO_ES3
