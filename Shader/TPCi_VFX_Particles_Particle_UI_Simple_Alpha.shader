...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_UI_Simple_Alpha" {
Properties {
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_TextureSample0, u_xlat0.xy).xyz;
    ...
    u_xlat16_1 = texture(_Alpha, u_xlat1.xy).x;
    u_xlat1.x = u_xlat16_1 * vs_COLOR0.w;
    u_xlat0.w = u_xlat1.x * _AlphaMultiply;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat2.xy = vs_TEXCOORD0.xy * _Alpha_ST.xy + _Alpha_ST.zw;
    u_xlat16_2 = texture(_Alpha, u_xlat2.xy).x;
    u_xlat0.x = u_xlat16_2 * u_xlat0.x;
    u_xlat0.w = u_xlat0.x * _AlphaMultiply;
#ifdef UNITY_ADRENO_ES3
    u_xlat0.w = min(max(u_xlat0.w, 0.0), 1.0);
#else
    u_xlat0.w = clamp(u_xlat0.w, 0.0, 1.0);
    ...
    u_xlat1.xyz = vec3(vec3(_AddWhite, _AddWhite, _AddWhite)) * u_xlat16_1.xyz + u_xlat16_1.xyz;
#ifdef UNITY_ADRENO_ES3
