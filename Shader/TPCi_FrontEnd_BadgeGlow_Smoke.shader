...
//
///////////////////////////////////////////
Shader "TPCi/FrontEnd/BadgeGlow_Smoke" {
Properties {
_TextureSample0 ("Texture Sample 0", 2D) = "white" { }
_Min ("Min", Float) = 0.33
_TextureOffset ("Texture Offset", Vector) = (0,-0.52,0,0)
...
void main()
{
    u_xlat0 = vs_TEXCOORD0.xyxy * vec4(3.0, 0.5, 4.0, 0.25);
    u_xlat0 = _Time.yyyy * vec4(0.0, -0.25, 0.0, -0.25) + u_xlat0;
    u_xlat16_1.xyz = texture(_Texture0, u_xlat0.xy).xyz;
    u_xlat16_0.xyz = texture(_Texture0, u_xlat0.zw).xyz;
    u_xlat0.xyz = (-u_xlat16_1.xyz) * u_xlat16_0.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat9 = vs_TEXCOORD0.y + _TextureOffset.xxyx.z;
    u_xlat9 = (-u_xlat9) + 1.0;
    u_xlat0.xyz = (-u_xlat0.xyz) + vec3(u_xlat9);
    u_xlat1.xyz = u_xlat0.xyz + (-vec3(vec3(_Min, _Min, _Min)));
    ...
    u_xlat9 = u_xlat1.x * vs_COLOR0.w;
    u_xlat1.w = u_xlat9 * _opacity;
    u_xlat2.xyz = vs_TEXCOORD0.yyy * vec3(0.546097577, 0.380348802, 0.387558699) + vec3(0.138142705, 0.554101586, 0.591114223);
...
void main()
{
    ...
    u_xlat16_1 = texture(_Texture0, u_xlat0.zw).x;
    u_xlat0.x = (-u_xlat16_0) * u_xlat16_1 + 1.0;
    u_xlat1 = vs_TEXCOORD0.y + _TextureOffset.xxyx.z;
    u_xlat1 = (-u_xlat1) + 1.0;
